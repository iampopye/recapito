  ...
  imports: [
    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        ...
        username: configService.get('DATABASE_USERNAME', 'rio'),
        password: configService.get('DATABASE_PASSWORD', 'rio_secret'),
        database: configService.get('DATABASE_NAME', 'rio_mailer'),
